// Starters Menu
let starterMenu: string[] = ["Garlic Bread", "Hummus", "Mozzarella and Tomatoes", "Olives"];

// Main Menu
let mainMenu: string[] = ["Lasagne", "Knödel", "Bean Soup", "Pizza"];

// Desert Menu
let dessertMenu: string[] = ["Tirramasu", "Trifel", "Cake", "Merrange"];

// Drinks Menu
let drinksMenu: string[] = ["Tea", "Coffee", "Wine", "Water"];

// Pills Array
let pillArr: string[] = ["starter", "main", "dessert", "drinks"];
...
for (let menu of pillArr) {
	switch (menu) {
		case "starter":
			...
			function setFoodMediaObj(foodItem: string, imgPath: string) {
				$(`#${menu}list`).append(`
                <li class="media mb-3">
...
window.onload = () => {
	function setStarClick(foodItem: String) {
		for (let i = 1; i <= 5; i++) {
